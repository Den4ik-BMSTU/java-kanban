...
public class EpicTest {
    ...
    public void startTimeShouldBeSetIfOneNull() {
        task_1.setStartTime(LocalDateTime.parse("13:00 - 20.08.2022", FORMATTER));
        addSubtasks();
        epic.calculateStartTime();
        Assertions.assertEquals("13:00 - 20.08.2022", epic.getStartTime().format(FORMATTER));
    }

    @Test
    public void startTimeShouldBeCalculatedAsTask_2() {
        task_1.setStartTime(LocalDateTime.parse("14:00 - 20.08.2022", FORMATTER));
        task_2.setStartTime(LocalDateTime.parse("11:00 - 20.08.2022", FORMATTER));
        task_3.setStartTime(LocalDateTime.parse("18:00 - 20.08.2022", FORMATTER));
        addSubtasks();
        epic.calculateStartTime();
        Assertions.assertEquals("11:00 - 20.08.2022", epic.getStartTime().format(FORMATTER));
    }
    ...
    public void endTimeShouldBeSetIfOneNull() {
        ...
        addSubtasks();
        epic.calculateStartTime();
        Assertions.assertEquals("14:00 - 20.08.2022", epic.getEndTime().format(FORMATTER));
    }
    ...
    public void endTimeShouldBeCalculatedAsTask_2() {
        task_1.setStartTime(LocalDateTime.parse("14:00 - 20.08.2022", FORMATTER));
        task_1.setDuration(60);
        task_2.setStartTime(LocalDateTime.parse("17:00 - 20.08.2022", FORMATTER));
        task_2.setDuration(90);
        task_3.setStartTime(LocalDateTime.parse("16:00 - 20.08.2022", FORMATTER));
        task_3.setDuration(10);
        addSubtasks();
        epic.calculateStartTime();
        Assertions.assertEquals("18:30 - 20.08.2022", epic.getEndTime().format(FORMATTER));
    }
}