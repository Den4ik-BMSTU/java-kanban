...
import task_manager.HTTPTaskManager;
...
public class HTTPTaskManagerTest extends TaskManagerTest<HTTPTaskManager> {
    ...
    public HTTPTaskManager createManager() {
        return new HTTPTaskManager("http://localhost:8080", "key");
    }
    ...
    public void shouldLoadFromEmptyServer() throws IOException, InterruptedException {
        // Act
        HTTPTaskManager emptyManager = HTTPTaskManager.loadFromServer("http://localhost:8080", "key");
    ...
    public void shouldLoadWithOneEmptyEpic() throws IOException, InterruptedException {
        ...
        // Act
        HTTPTaskManager oneEpicManager = HTTPTaskManager.loadFromServer("http://localhost:8080", "key");
    ...
    public void shouldLoadWithEmptyHistory() throws IOException, InterruptedException {
        ...
        // Act
        HTTPTaskManager emptyHistoryManager = HTTPTaskManager.loadFromServer("http://localhost:8080", "key");
    ...
    public void shouldHaveSameContent() throws IOException, InterruptedException {
        ...
        // Act
        HTTPTaskManager standardManager = HTTPTaskManager.loadFromServer("http://localhost:8080", "key");
