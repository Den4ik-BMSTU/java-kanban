...
public abstract class TaskManagerTest<T extends TaskManager> {
    ...
    public void shouldNotAddTaskWithTimeIntersection() {
        ...
        task_1.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        task_2.setDuration(60);
        task_2.setStartTime(LocalDateTime.parse("12:30 - 21.08.2022", FORMATTER));
    ...
    public void shouldNotAddSubTaskWithTimeIntersection() {
        manager.addEpic(epic_1);
        subTask_1.setStartTime(LocalDateTime.parse("13:00 - 21.08.2022", FORMATTER));
        int id_1 = manager.addSubTask(subTask_1);
        subTask_2.setStartTime(LocalDateTime.parse("13:00 - 21.08.2022", FORMATTER));
    ...
    public void shouldUpdateTaskWithSameStartTime() {
        ...
        int id = manager.addTask(task_1);
        task_2.setId(id);
        task_2.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        int updatedId = manager.updateTask(task_2);
    ...
    public void shouldNotUpdateTaskWithTimeIntersection() {
        task_1.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        task_2.setStartTime(LocalDateTime.parse("14:00 - 21.08.2022", FORMATTER));
        add2TestTasks();
        Task task_3 = new Task("T3", "TD3", TaskStatus.NEW,
                60, LocalDateTime.parse("14:00 - 21.08.2022", FORMATTER));
    ...
    public void shouldUpdateSubTaskWithSameStartTime() {
        manager.addEpic(epic_1);
        subTask_1.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        int id = manager.addSubTask(subTask_1);
        subTask_2.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        subTask_2.setId(id);
        int updatedId = manager.updateSubTask(subTask_2);
        Assertions.assertEquals(1, manager.getAllSubTasks().size());
        Assertions.assertEquals(id, updatedId);
    ...
    public void shouldNotUpdateSubTaskWithTimeIntersection() {
        manager.addEpic(epic_1);
        subTask_1.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        subTask_2.setStartTime(LocalDateTime.parse("14:00 - 21.08.2022", FORMATTER));
        subTask_3.setStartTime(LocalDateTime.parse("14:00 - 21.08.2022", FORMATTER));
        int id_1 = manager.addSubTask(subTask_1);
        manager.addSubTask(subTask_2);
    ...
    public void getPrioritizedTasks() {
        task_1.setStartTime(LocalDateTime.parse("10:00 - 21.08.2022", FORMATTER));
        task_2.setStartTime(LocalDateTime.parse("12:00 - 21.08.2022", FORMATTER));
        add2TestEpics();
        add2TestTasks();
        subTask_1.setStartTime(LocalDateTime.parse("10:30 - 21.08.2022", FORMATTER));
        subTask_2.setStartTime(LocalDateTime.parse("13:00 - 21.08.2022", FORMATTER));
        subTask_3.setStartTime(LocalDateTime.parse("11:30 - 21.08.2022", FORMATTER));
        subTask_4.setStartTime(LocalDateTime.parse("12:30 - 21.08.2022", FORMATTER));
        subTask_5.setStartTime(LocalDateTime.parse("11:00 - 21.08.2022", FORMATTER));
        add5TestSubTasks();
